...
public class ManagerVenta {
	...
	public VentRegistro registroventa(VentRegistro nuevoVenta) throws Exception {
		FactDetalle fac = (FactDetalle) mDAO.findById(FactDetalle.class,
				nuevoVenta.getFactDetalle().getIdFactDetalle());
		ThmEmpleado thmemp = (ThmEmpleado) mDAO.findById(ThmEmpleado.class,
				nuevoVenta.getThmEmpleado().getIdThmEmpleado());
